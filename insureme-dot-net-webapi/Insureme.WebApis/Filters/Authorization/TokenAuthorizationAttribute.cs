...
namespace Insureme.WebApis.Filters.Authorization
{
    public class TokenAuthorization : AuthorizationFilterAttribute
    {
        ...
        {
            var content = new GenericResponse<AuthorizationFailResponse>
            {
                Error = new Error
                {
            ...
            var response = new HttpResponseMessage
            {
                ...
                Content = new ObjectContent<GenericResponse<AuthorizationFailResponse>>(
                    content,
